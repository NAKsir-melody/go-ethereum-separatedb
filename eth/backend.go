...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	stateDb, err := ctx.OpenDatabase("statedata", config.DatabaseCache, config.DatabaseHandles, "eth/db/statedata/")
	if err != nil {
		return nil, err
	}
	...
	chainConfig, genesisHash, genesisErr = core.SetupGenesisBlockWithOverride(stateDb, config.Genesis, config.ConstantinopleOverride)
